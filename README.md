...
```sh
git clone https://github.com/NukedOne/pyhstr
cd pyhstr
...
Licensed under the [MIT License](https://opensource.org/licenses/MIT). For details, see [LICENSE](https://github.com/NukedOne/pyhstr/blob/master/LICENSE).